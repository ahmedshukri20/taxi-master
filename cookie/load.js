(function (window, undefined){
	...
	AcceptCookie.prototype = {
		...
		addCookieBar: function(){
			...
			htmlBar += '<p>Wij gebruiken cookies om uw ervaring met onze website te verbeteren. Door deze website te gebruiken gaat u akkoord met het gebruik van cookies.</p>';
			htmlBar += '<div class="pjAcceptCookieBarActions">';
			htmlBar += '<button type="button" class="pjAcceptCookieBarBtn">Begrepen</button>';
			htmlBar += '</div>';
			htmlBar += '</form>';
			htmlBar += '</div>';
