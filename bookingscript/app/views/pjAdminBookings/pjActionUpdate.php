        				...
        				<div class="row">
        					<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="sub_total" name="sub_total" value="<?php echo pjSanitize::clean($tpl['arr']['sub_total']); ?>" readonly="readonly" class="form-control">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="tax" name="tax" value="<?php echo pjSanitize::clean($tpl['arr']['tax']); ?>" readonly="readonly" class="form-control" data-tax="<?php echo $tpl['option_arr']['o_tax_payment'];?>">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="total" name="total" value="<?php echo pjSanitize::clean($tpl['arr']['total']); ?>" readonly="readonly" class="form-control">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="deposit" name="deposit" value="<?php echo pjSanitize::clean($tpl['arr']['deposit']); ?>" readonly="readonly" class="form-control" data-deposit="<?php echo $tpl['option_arr']['o_deposit_payment'];?>">
							...
							if (in_array($tpl['option_arr']['o_bf_include_fname'], array(2, 3)))
							{
							    ...
							    <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_fname" id="c_fname" class="form-control<?php echo $tpl['option_arr']['o_bf_include_fname'] == 3 ? ' tr_field_required' : NULL; ?>" data-msg-required="<?php __('tr_field_required', false, true);?>"/>
                                    </div>
                                </div><!-- /.col-md-3 -->
							    <?php
							    $field++;
							...
							if (in_array($tpl['option_arr']['o_bf_include_lname'], array(2, 3)))
							{
							    ...
							    <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_lname" id="c_lname" class="form-control<?php echo $tpl['option_arr']['o_bf_include_lname'] == 3 ? ' tr_field_required' : NULL; ?>" data-msg-required="<?php __('tr_field_required', false, true);?>"/>
                                    </div>
                                </div><!-- /.col-md-3 -->
							    <?php
							    $field++;
							...
							if (in_array($tpl['option_arr']['o_bf_include_email'], array(2, 3)))
							{
							    ...
							    <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_email" id="c_email" class="form-control email<?php echo $tpl['option_arr']['o_bf_include_email'] == 3 ? ' tr_field_required' : NULL; ?>" data-msg-required="<?php __('tr_field_required', false, true);?>"/>
                                    </div>
                                </div><!-- /.col-md-3 -->
							    <?php
							    $field++;
							...
							if (in_array($tpl['option_arr']['o_bf_include_email'], array(2, 3)))
							{
							    ...
							    <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="c_password" id="c_password" class="form-control<?php echo $tpl['option_arr']['o_bf_include_email'] == 3 ? ' tr_field_required' : NULL; ?>" data-msg-required="<?php __('tr_field_required', false, true);?>"/>
                                    </div>
                                </div><!-- /.col-md-3 -->
							    <?php
							    $field++;
							...
							if (in_array($tpl['option_arr']['o_bf_include_phone'], array(2, 3)))
							{
							    ...
							    <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_phone" id="c_phone" class="form-control<?php echo $tpl['option_arr']['o_bf_include_phone'] == 3 ? ' tr_field_required' : NULL; ?>" data-msg-required="<?php __('tr_field_required', false, true);?>"/>
                                    </div>
                                </div><!-- /.col-md-3 -->
							    <?php
							    $field++;
