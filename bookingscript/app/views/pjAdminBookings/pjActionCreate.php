        				...
        				<div class="row">
        					<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="sub_total" name="sub_total" readonly="readonly" class="form-control">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="tax" name="tax" readonly="readonly" class="form-control" data-tax="<?php echo $tpl['option_arr']['o_tax_payment'];?>">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="total" name="total" readonly="readonly" class="form-control">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" id="deposit" name="deposit" readonly="readonly" class="form-control" data-deposit="<?php echo $tpl['option_arr']['o_deposit_payment'];?>">
